...
export default function DocsPage() {
  return (
    <div>
      ...
      <div className="srcl-grid srcl-grid-3" style={{ marginTop: 'calc(var(--line-height) * 2)', marginBottom: 'calc(var(--line-height) * 2)' }}>
      ...
      <Card title="Need Help?">
        <div className="srcl-grid srcl-grid-2" style={{ gap: '2ch' }}>
          <div>
            <h4 style={{ marginBottom: 'calc(var(--line-height) * 0.5)' }}>Community Resources</h4>
          ...
          <div>
            <h4 style={{ marginBottom: 'calc(var(--line-height) * 0.5)' }}>Documentation</h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li style={{ padding: 0 }}>
...
omnivore graph crawl-results.json --output knowledge-graph.db`}</CodeBlock>
      ...
      <p style={{ marginTop: 'calc(var(--line-height) * 2)', color: 'var(--theme-foreground-secondary)' }}>
